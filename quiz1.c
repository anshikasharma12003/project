...
scanf("%d",&ans);
    ...
    {
        printf("your answer is wrong :(\n");
        printf("correct ans=3\n");
    }

    printf("Question 3:How can you create a variable with the numeric value 5?\n");
    printf("1) num=5;\t");
    printf("2) val num=5;\n");
    printf("3) num=5 int;\t");
    printf("4) int num=5;\n");
    ...
    printf("Question 7:which format specifier is used to print integers?\n");
    printf("1) %%d\t");
    printf("2) %%c\n");
    printf("3) %%s\t");
    printf("4) %%f\n");
    ...
    printf("Question 14:how do you start writing an if statement in C?\n");
    printf("1) if x>y()\t");
    printf("2) if(x>y)\n");
